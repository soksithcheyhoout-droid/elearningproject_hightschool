...
// Strictly organized by Grade (1 to 12) and Stream ('science' | 'social' | 'general')

export const arenaMasterQuestionBank = [
  // =========================================================================
  // GRADE 12 - NATURAL SCIENCE STREAM (ថ្នាក់វិទ្យាសាស្ត្រពិត ទី១២ - BacII)
  // Subjects: គណិតវិទ្យា, រូបវិទ្យា, គីមីវិទ្យា, ជីវវិទ្យា
  // =========================================================================
  ...
  // =========================================================================
  // GRADE 12 - SOCIAL SCIENCE STREAM (ថ្នាក់វិទ្យាសាស្ត្រសង្គម ទី១២ - BacII)
  // Subjects: ភាសាខ្មែរ, ប្រវត្តិវិទ្យា, ភូមិវិទ្យា, សីលធម៌-ពលរដ្ឋ, សេដ្ឋកិច្ច
  // =========================================================================
  ...
  },
  {
    ...
    subject: 'ភាសាខ្មែរ',
    category: 'Khmer Literature',
    q: 'តួអង្គចៅចិត្រក្នុងរឿង «កុលាបប៉ៃលិន» ធ្វើការជាអ្វីនៅផ្ទះហ្លួងរតនសម្បត្តិ?៖',
    options: ['អ្នកជីកត្បូង និងមើលការខុសត្រូវ', 'អ្នកបើកបរឡាន', 'មេការធំ', 'អ្នកដាំស្ល'],
    answer: 0,
    explanation: 'ចៅចិត្របានធ្វើការជាអ្នកជីកត្បូង និងដោយភាពស្មោះត្រង់បានទទួលការទុកចិត្តពីហ្លួងរតនសម្បត្តិ'
  },
  ...
  // =========================================================================
  // GRADE 11 - NATURAL SCIENCE STREAM (ថ្នាក់វិទ្យាសាស្ត្រពិត ទី១១)
  // Subjects: គណិតវិទ្យា, រូបវិទ្យា, គីមីវិទ្យា, ជីវវិទ្យា
  // =========================================================================
  {
    grade: '11',
  ...
  },
  {
    ...
    subject: 'គណិតវិទ្យា',
    category: 'Trigonometry',
    q: 'រូបមន្ត cos(2x) ស្មើនឹង៖',
    options: ['cos²(x) - sin²(x)', '2 sin(x) cos(x)', '1 + 2 sin²(x)', 'cos²(x) + sin²(x)'],
    answer: 0,
  ...
  },
  {
    ...
    subject: 'រូបវិទ្យា',
    category: 'Energy',
    q: 'ថាមពលស៊ីនេទិច (Kinetic Energy) នៃអង្គធាតុមានម៉ាស m ល្បឿន v គឺ៖',
    options: ['Ek = 1/2 m v²', 'Ek = m g h', 'Ek = m v', 'Ek = 1/2 k x²'],
    answer: 0,
    explanation: 'Ek = 1/2 m v²'
  },
  {
    grade: '11',
    stream: 'science',
  ...
  },
  {
    ...
    q: 'ដំណើរការដែលរុក្ខជាតិបៃតងផលិតគ្លុយកូស និងអុកស៊ីសែនដោយប្រើពន្លឺព្រះអាទិត្យហៅថា៖',
    options: ['រស្មីសំយោគ (Photosynthesis)', 'ដំណកដង្ហើម', 'រំហួតទឹក', 'ការបំប្លែងសារធាតុ'],
    answer: 0,
    explanation: '6CO₂ + 6H₂O + ពន្លឺ → C₆H₁₂O₆ + 6O₂ (រស្មីសំយោគ)'
  },

  // =========================================================================
  // GRADE 11 - SOCIAL SCIENCE STREAM (ថ្នាក់វិទ្យាសាស្ត្រសង្គម ទី១១)
  // Subjects: ភាសាខ្មែរ, ប្រវត្តិវិទ្យា, ភូមិវិទ្យា, សីលធម៌-ពលរដ្ឋ, សេដ្ឋកិច្ច
  // =========================================================================
  ...
  // --- Khmer Literature 11 ---
  {
    ...
    subject: 'ភាសាខ្មែរ',
    category: 'Khmer Literature',
    q: 'រឿង «ស៊ីមអ្នកបរឡាន» ជាស្នាដៃនិពន្ធរបស់អ្នកណា?៖',
    options: ['លោក អ៊ឹម ថុក', 'លោក នូ ហាច', 'លោក ញ៉ុក ថែម', 'លោក រីម គីន'],
    answer: 0,
    explanation: 'រឿងស៊ីមអ្នកបរឡាន និពន្ធដោយលោក អ៊ឹម ថុក ក្នុងឆ្នាំ ១៩៥៦ ឆ្លុះបញ្ចាំងពីជីវិតកម្មករ'
  },
  {
    grade: '11',
    stream: 'social',
    ...
    options: ['ព្រះបាទអង្គឌួង', 'អ្នកឧកញ៉ាវិបុលរាជសេនា នូ កន', 'កវីក្រមង៉ុយ', 'ភិក្ខុសោម'],
    answer: 0,
  ...
  },
  {
    ...
    subject: 'ភាសាខ្មែរ',
    category: 'Khmer Literature',
    q: 'រឿង «ផ្កាស្រពោន» និពន្ធដោយអ្នកនិពន្ធរូបណា?៖',
    options: ['លោក នូ ហាច', 'លោក ញ៉ុក ថែម', 'លោក រីម គីន', 'លោក គង់ ប៊ុនឈឿន'],
    answer: 0,
    explanation: 'រឿងផ្កាស្រពោន និពន្ធដោយលោក នូ ហាច ក្នុងឆ្នាំ ១៩៤៧ (បោះពុម្ព ១៩៤៩)'
  },
  {
    grade: '11',
    stream: 'social',
    subject: 'ភាសាខ្មែរ',
    category: 'Grammar',
    q: 'ពាក្យ «មាតុភូមិ» ជាពាក្យកម្ចីមកពីភាសាអ្វី?៖',
    options: ['បាលី-សំស្ក្រឹត', 'បារាំង', 'ចិន', 'សៀម'],
    answer: 0,
    explanation: 'មាតុ (ម្តាយ) + ភូមិ (ដី/ស្រុក) ជាពាក្យផ្សំបាលី-សំស្ក្រឹត មានន័យថា ស្រុកកំណើត'
  },
  {
    grade: '11',
    stream: 'social',
    subject: 'ភាសាខ្មែរ',
    category: 'Grammar',
    q: 'នៅក្នុងប្រយោគ «សិស្សខិតខំរៀនសូត្រ» ពាក្យ «ខិតខំ» បំពេញមុខងារជា៖',
    options: ['គុណកិរិយា (Adverb)', 'គុណនាម', 'នាម', 'ធ្នាក់'],
    answer: 0,
    explanation: '«ខិតខំ» បញ្ជាក់ន័យឱ្យកិរិយាស័ព្ទ «រៀនសូត្រ» ដូច្នេះវាជាគុណកិរិយា'
  },
  ...
  },
  {
    ...
    subject: 'ប្រវត្តិវិទ្យា',
    category: 'Khmer Empire',
    q: 'ព្រះមហាក្សត្រខ្មែរដែលបានកសាងប្រាសាទបាយ័ន និងមន្ទីរពេទ្យ ១០២ កន្លែងទូទាំងប្រទេសគឺ៖',
    options: ['ព្រះបាទជ័យវរ្ម័នទី ៧', 'ព្រះបាទសូរ្យវរ្ម័នទី ២', 'ព្រះបាទឥន្ទ្រវរ្ម័នទី ១', 'ព្រះបាទជ័យវរ្ម័នទី ៣'],
    answer: 0,
    explanation: 'ព្រះបាទជ័យវរ្ម័នទី ៧ (ចុងសតវត្សរ៍ទី ១២ ដើមទី ១៣) ជាព្រះមហាក្សត្រមហារុងរឿងនៃអាណាចក្រអង្គរ'
  },
  {
    grade: '11',
    stream: 'social',
    ...
    q: 'ប្រទេសកម្ពុជាបានធ្លាក់ក្រោមអាណាព្យាបាលបារាំងនៅឆ្នាំណា?៖',
    options: ['១៨៦៣', '១៩៥៣', '១៩៧០', '១៨៨៤'],
    answer: 0,
    explanation: 'ព្រះបាទនរោត្តម បានចុះសន្ធិសញ្ញាដាក់កម្ពុជាក្រោមអាណាព្យាបាលបារាំងនៅថ្ងៃទី ១១ សីហា ១៨៦៣'
  },
  {
    grade: '11',
    stream: 'social',
    subject: 'ប្រវត្តិវិទ្យា',
    category: 'World History',
    q: 'សង្គ្រាមលោកលើកទី ១ បានកើតឡើងក្នុងចន្លោះឆ្នាំណា?៖',
    options: ['១៩១៤ - ១៩១៨', '១៩៣៩ - ១៩៤៥', '១៩៥០ - ១៩៥៣', '១៨៧០ - ១៨៧១'],
    answer: 0,
    explanation: 'សង្គ្រាមលោកលើកទី ១ ផ្ទុះឡើងនៅឆ្នាំ ១៩១៤ និងបញ្ចប់នៅឆ្នាំ ១៩១៨'
  },
  {
    grade: '11',
    stream: 'social',
    subject: 'ប្រវត្តិវិទ្យា',
    category: 'World History',
    q: 'សង្គ្រាមលោកលើកទី ២ បានផ្ទុះឡើងជាផ្លូវការនៅពេលអាល្លឺម៉ង់វាយប្រហារប្រទេសណា?៖',
    options: ['ប្រទេសប៉ូឡូញ (Poland)', 'ប្រទេសបារាំង', 'ប្រទេសអង់គ្លេស', 'សហភាពសូវៀត'],
    answer: 0,
    explanation: 'នៅថ្ងៃទី ១ កញ្ញា ១៩៣៩ អាល្លឺម៉ង់ណាស៊ីបានចូលឈ្លានពានប៉ូឡូញ ធ្វើឱ្យផ្ទុះសង្គ្រាមលោកលើកទី ២'
  },
  ...
  // --- Geography 11 ---
  {
    ...
    q: 'តំបន់ខ្ពង់រាប និងតំបន់ភ្នំនៅកម្ពុជា សម្បូរទៅដោយធនធានដីប្រភេទណាសម្រាប់ដាំដំណាំកសិ-ឧស្សាហកម្ម?៖',
    options: ['ដីក្រហមបាសាល់ (Basaltic Red Soil)', 'ដីល្បាប់', 'ដីខ្សាច់', 'ដីប្រៃ'],
    answer: 0,
    explanation: 'ដីក្រហមបាសាល់ (នៅកំពង់ចាម ត្បូងឃ្មុំ រតនគិរី មណ្ឌលគិរី) ស័ក្តិសមបំផុតសម្រាប់កៅស៊ូ កាហ្វេ ស្វាយចន្ទី'
  },
  {
    grade: '11',
    stream: 'social',
    subject: 'ភូមិវិទ្យា',
    category: 'Hydrology',
    q: 'ទន្លេចតុមុខ គឺជាចំណុចប្រសព្វនៃទន្លេធំៗចំនួនប៉ុន្មាន?៖',
    options: ['៤ ទន្លេ (មេគង្គលើ មេគង្គក្រោម បាសាក់ ទន្លេសាប)', '២ ទន្លេ', '៣ ទន្លេ', '៥ ទន្លេ'],
    answer: 0,
    explanation: 'ទន្លេចតុមុខនៅភ្នំពេញជាចំណុចប្រសព្វនៃទន្លេមេគង្គលើ ទន្លេមេគង្គក្រោម ទន្លេបាសាក់ និងទន្លេសាប'
  },
  {
    grade: '11',
    stream: 'social',
    ...
    q: 'ប្រទេសណាខ្លះជាសមាជិកស្ថាបនិកទាំង ៥ ដំបូងនៃសមាគមអាស៊ាន (ASEAN)?៖',
    options: ['ឥណ្ឌូណេស៊ី ម៉ាឡេស៊ី ហ្វីលីពីន សិង្ហបុរី ថៃ', 'កម្ពុជា ឡាវ វៀតណាម មីយ៉ាន់ម៉ា ព្រុយណេ', 'ចិន ជប៉ុន កូរ៉េ ឥណ្ឌា អូស្ត្រាលី', 'ថៃ វៀតណាម សិង្ហបុរី កម្ពុជា ឡាវ'],
    answer: 0,
    explanation: 'ស្ថាបនិកទាំង ៥ គឺ ឥណ្ឌូណេស៊ី ម៉ាឡេស៊ី ហ្វីលីពីន សិង្ហបុរី និងថៃ (៨ សីហា ១៩៦៧)'
  },
  {
    grade: '11',
    stream: 'social',
    subject: 'ភូមិវិទ្យា',
    category: 'Atmosphere',
    q: 'ខ្យល់មូសុងនិរតី (Southwest Monsoon) បក់នាំមកនូវអាកាសធាតុបែបណាដល់កម្ពុជា?៖',
    options: ['ភ្លៀងធ្លាក់ជោកជាំ និងសំណើមខ្ពស់ (រដូវវស្សា)', 'អាកាសធាតុត្រជាក់ និងស្ងួត', 'អាកាសធាតុក្តៅហួតហែង', 'ខ្យល់ព្យុះព្រិល'],
    answer: 0,
    explanation: 'ខ្យល់មូសុងនិរតី (ពីឧសភា ដល់តុលា) បក់ពីមហាសមុទ្រឥណ្ឌានាំទឹកភ្លៀងមកកម្ពុជា'
  },
  ...
  // --- Civics & Morals 11 ---
  {
    ...
    stream: 'social',
    subject: 'សីលធម៌-ពលរដ្ឋ',
    category: 'Civic Responsibilities',
    q: 'កាតព្វកិច្ចចម្បងរបស់ប្រជាពលរដ្ឋកម្ពុជាគ្រប់រូបដែលមានចែងក្នុងរដ្ឋធម្មនុញ្ញរួមមាន៖',
    options: ['គោរពច្បាប់ ស្រឡាញ់មាតុភូមិ និងការពារជាតិ', 'បង់ពន្ធតាមការស្ម័គ្រចិត្ត', 'មិនបាច់គោរពច្បាប់ចរាចរណ៍', 'ពុំមានកាតព្វកិច្ចអ្វីឡើយ'],
    answer: 0,
    explanation: 'ពលរដ្ឋមានកាតព្វកិច្ចគោរពរដ្ឋធម្មនុញ្ញ ការពារមាតុភូមិ និងចូលរួមអភិវឌ្ឍប្រទេសជាតិ'
  },
  {
    grade: '11',
    stream: 'social',
    subject: 'សីលធម៌-ពលរដ្ឋ',
    category: 'Culture & Morals',
    q: 'ប្រពៃណីនៃការសំពះរបស់ខ្មែរចែកចេញជាប៉ុន្មានរបៀបតាមឋានានុក្រម?៖',
    options: ['៥ របៀប (ស្មើទ្រូង, ស្មើមាត់, ស្មើច្រមុះ, ស្មើយញ្ចើម, លើក្បាល)', '៣ របៀប', '៤ របៀប', '២ របៀប'],
    answer: 0,
    explanation: 'ការសំពះខ្មែរមាន ៥ ថ្នាក់៖ មនុស្សស្មើគ្នា, ចាស់ព្រឹទ្ធាចារ្យ, មាតាបិតា/គ្រូ, ព្រះសង្ឃ/ស្តេច, ព្រះរតនត្រ័យ'
  },
  {
    grade: '11',
    stream: 'social',
    ...
    q: 'អាយុដែលប្រជាពលរដ្ឋខ្មែរទាំងពីរភេទមានសិទ្ធិបោះឆ្នោតជ្រើសតាំងតំណាងរាស្ត្រគឺ៖',
    options: ['ចាប់ពី ១៨ ឆ្នាំឡើងទៅ', 'ចាប់ពី ១៦ ឆ្នាំ', 'ចាប់ពី ២១ ឆ្នាំ', 'ចាប់ពី ២៥ ឆ្នាំ'],
    answer: 0,
    explanation: 'ប្រជាពលរដ្ឋខ្មែរមានសិទ្ធិបោះឆ្នោតចាប់ពីអាយុ ១៨ ឆ្នាំឡើងទៅ'
  },
