export const curriculumData = [
  ...
  // ==========================================
  {
    ...
    teacher: 'នាយកដ្ឋានអភិវឌ្ឍន៍កម្មវិធីសិក្សាបឋមសិក្សា MoTDAR',
  ...
  },
  {
    ...
    teacher: 'នាយកដ្ឋានស្រាវជ្រាវគរុកោសល្យ MoTDAR',
  ...
  // ==========================================
  {
    ...
    teacherRole: 'គណៈកម្មការរៀបចំការប្រឡងសញ្ញាបត្រឌីប្លូម MoTDAR',
    progress: 85,
    totalChapters: 6,
    totalLessons: 24,
    quizzesCount: 12,
  ...
  // 1. Mathematics (Grade 12 - Advanced Math MoTDAR)
  {
    ...
    teacherRole: 'នាយកដ្ឋានអភិវឌ្ឍន៍កម្មវិធីសិក្សា MoTDAR',
    progress: 75,
    totalChapters: 6,
    totalLessons: 24,
    quizzesCount: 12,
    bannerImg: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=1200&q=80',
    descriptionKm: 'កម្មវិធីសិក្សាគណិតវិទ្យាផ្លូវការថ្នាក់ទី១២ ស្របតាមក្របខ័ណ្ឌជាតិ MoTDAR ផ្តោតលើលីមីត ដេរីវេ អាំងតេក្រាល ចំនួនកុំផ្លិច ធរណីមាត្រក្នុងលំហ និងប្រូបាប៊ីលីតេ។',
