...
export const playgroundGamesData = [
  ...
  createGame('soc-k-01', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'រឿង «ទុំទាវ» & កវីភិក្ខុសោម (Tum Teav Master)', 'Tum Teav Tragic Romance', 'វិភាគតួអង្គទុំ ទាវ ពេជ្រ ណោ មេយាយផាន់ និងទំនៀមទម្លាប់។', 'intermediate', 210, 60, 'BookOpen', 'Classical Literature', [
    { q: 'រឿង «ទុំទាវ» និពន្ធដោយកវីណា?', options: ['ភិក្ខុសោម', 'ក្រមង៉ុយ', 'ព្រះបាទអង្គឌួង', 'នូ កន'], answer: 0, explanation: 'ភិក្ខុសោម (១៩១៥)' },
    { q: 'មូលហេតុនៃសោកនាដកម្មរឿងទុំទាវគឺ៖', options: ['ទំនៀមទម្លាប់នំមិនធំជាងនាឡិ និងការលោភលន់', 'ការមិនចេះអក្សរ', 'សង្គ្រាម', 'ធម្មជាតិ'], answer: 0, explanation: 'ទំនៀមទម្លាប់បុរាណ និងការបង្ខិតបង្ខំ' }
  ]),
  createGame('soc-k-02', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'រឿង «កុលាបប៉ៃលិន» & ចៅចិត្រ (Kolab Pailin)', 'Kolab Pailin Realist Novel', 'ស្វែងយល់ពីគុណធម៌តួអង្គចៅចិត្រ និងឃុននរិន្ទ។', 'intermediate', 200, 60, 'BookOpen', 'Modern Novels', [
    { q: 'រឿង «កុលាបប៉ៃលិន» និពន្ធដោយ៖', options: ['ញ៉ុក ថែម', 'ភិក្ខុសោម', 'រីម គីន', 'ឌឹក គាម'], answer: 0, explanation: 'ញ៉ុក ថែម' },
    { q: 'តួអង្គ «ចៅចិត្រ» ជាតំណាងឱ្យ៖', options: ['ភាពស្មោះត្រង់ ឧស្សាហ៍ព្យាយាម មានសីលធម៌', 'កំសាក', 'អាត្មានិយម', 'ខ្ជិលច្រអូស'], answer: 0, explanation: 'ភាពស្មោះត្រង់ និងការតស៊ូ' }
  ]),
  createGame('soc-k-03', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'រឿង «ភូមិតិរច្ឆាន» (Phum Tirachhan Revolt)', 'Phum Tirachhan Historical Revolt', 'វិភាគចលនាតស៊ូប្រឆាំងនឹងបារាំងបាដេស ឡាចាត។', 'master', 230, 60, 'Feather', 'Historical Novels', [
    { q: 'រឿង «ភូមិតិរច្ឆាន» និពន្ធដោយ៖', options: ['ឌឹក គាម និង ឌី ឈាន', 'ញ៉ុក ថែម', 'ភិក្ខុសោម', 'សួន សុរិន្ទ'], answer: 0, explanation: 'ឌឹក គាម និង ឌី ឈាន' },
    { q: 'មូលហេតុនៃការបះបោរភូមិក្រាំងលាវគឺ៖', options: ['ការគាបសង្កត់ទារពន្ធដារយ៉ាងឃោរឃៅពីបារាំងបាដេស', 'ជម្លោះដីធ្លី', 'អំណាច', 'សាសនា'], answer: 0, explanation: 'ការគាបសង្កត់ពន្ធដារបារាំង' }
  ]),
  createGame('soc-k-04', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'តែងសេចក្តីពន្យល់ ពិភាក្សា (Essay Frameworks)', 'Khmer Essay Structure & Outline', 'ស្ទាត់ជំនាញបែងចែកផ្តើមសេចក្តី តួសេចក្តី និងបញ្ចប់សេចក្តី។', 'master', 250, 60, 'FileText', 'Essay Writing', [
    { q: 'គម្រោងតែងសេចក្តីមានប៉ុន្មានផ្នែក?', options: ['៣ ផ្នែក (ផ្តើម, តួ, បញ្ចប់)', '២ ផ្នែក', '៤ ផ្នែក', '៥ ផ្នែក'], answer: 0, explanation: '៣ ផ្នែក' },
    { q: 'តែងសេចក្តីបែប «ពិភាក្សា» ត្រូវមាន៖', options: ['មតិស្រប និង មតិផ្ទុយ រួចសំយោគ', 'ពន្យល់តែម្យ៉ាង', 'រៀបរាប់ដំណើរ', 'គ្មានការវែកញែក'], answer: 0, explanation: 'ស្រប ផ្ទុយ សំយោគ' }
  ]),
  createGame('soc-k-05', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'សំនួនវោហារ ឧបមា (Figures of Speech)', 'Metaphors & Similes', 'ញែកឧបមាន សទិសភាព និងបុគ្គលាធិប្បាយ។', 'intermediate', 200, 60, 'Feather', 'Khmer Linguistics', [
    { q: '«ចិត្តស្អាតដូចកែវ» ជាសំនួន៖', options: ['ឧបមា (Simile)', 'បំផ្លើស', 'បុគ្គលាធិប្បាយ', 'កិរិយា'], answer: 0, explanation: 'សំនួនឧបមា' },
    { q: '«ព្រៃឈើខ្សឹបប្រាប់ខ្ញុំ» ជាសំនួន៖', options: ['បុគ្គលាធិប្បាយ', 'ឧបមា', 'បំផ្លើស', 'សទិសន័យ'], answer: 0, explanation: 'បុគ្គលាធិប្បាយ' }
  ]),
  createGame('soc-k-06', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'សុភាសិតខ្មែរ (Khmer Proverbs)', 'Proverbs & Folk Wisdom', 'វិភាគតម្លៃអប់រំនៃសុភាសិតបុរាណខ្មែរ។', 'beginner', 190, 60, 'BookMarked', 'Khmer Culture', [
    { q: '«ចេះដប់មិនស្មើប្រសប់មួយ» អប់រំអំពី៖', options: ['ការអនុវត្តជាក់ស្តែង និងជំនាញពិតប្រាកដ', 'មិនបាច់រៀនច្រើន', 'ចេះដប់គឺអន់', 'គ្មានន័យ'], answer: 0, explanation: 'ជំនាញអនុវត្តជាក់ស្តែង' },
    { q: '«ទូកទៅកំពង់នៅ» មានន័យធៀបថា៖', options: ['មនុស្សផ្លាស់ប្តូរតែប្រទេសជាតិនៅស្ថិតស្ថេរ', 'ទូកមិនទៅណា', 'កំពង់ផែត្រូវរុះរើ', 'រឿងទូក'], answer: 0, explanation: 'មនុស្សផ្លាស់ប្តូរតែជាតិនៅគង់វង្ស' }
  ]),
  createGame('soc-k-07', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'រឿង «សុភាត» & រីម គីន (Sophat Novel)', 'Sophat Early Modern Novel', 'ស្វែងយល់ពីជីវិតតស៊ូរបស់សុភាត និងសង្គមខ្មែរទសវត្សរ៍ ១៩៣០។', 'intermediate', 200, 60, 'BookOpen', 'Modern Novels', [
    { q: 'រឿង «សុភាត» និពន្ធដោយអ្នកនិពន្ធណា?', options: ['រីម គីន (១៩៣៨)', 'ញ៉ុក ថែម', 'ភិក្ខុសោម', 'ក្រមង៉ុយ'], answer: 0, explanation: 'រីម គីន' },
    { q: 'រឿងសុភាតត្រូវបានចាត់ទុកជា៖', options: ['ប្រលោមលោកទំនើបដំបូងគេបង្អស់នៃអក្សរសិល្ប៍ខ្មែរ', 'កំណាព្យបុរាណ', 'រឿងព្រេង', 'ច្បាប់ស្រី'], answer: 0, explanation: 'ប្រលោមលោកទំនើបបែបបស្ចិមប្រទេសដំបូង' }
  ]),
  createGame('soc-k-08', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'រឿង «ស៊ីមអ្នកបរឡាន» (Sim the Chauffeur)', 'Sim the Driver Realist Novel', 'ស្វែងយល់ពីជីវភាពវណ្ណៈកម្មករ និងស្មារតីស្នេហាជាតិ។', 'intermediate', 210, 60, 'BookOpen', 'Social Realism', [
    { q: 'រឿង «ស៊ីមអ្នកបរឡាន» និពន្ធដោយ៖', options: ['អ៊ឹម ថុក (១៩៥៦)', 'ញ៉ុក ថែម', 'ឌឹក គាម', 'រីម គីន'], answer: 0, explanation: 'អ៊ឹម ថុក' },
    { q: 'តួអង្គ «ស៊ីម» ជាតំណាងឱ្យ៖', options: ['វណ្ណៈកម្មករដែលមានស្មារតីភ្ញាក់រលឹក និងសាមគ្គីភាព', 'សេដ្ឋី', 'មន្ត្រីសក្តិភូមិ', 'ឈ្មួញកណ្តាល'], answer: 0, explanation: 'វណ្ណៈកម្មករតស៊ូ' }
  ]),
  createGame('soc-k-09', 'social', 'អក្សរសាស្ត្រខ្មែរ', 'khmer', 'ច្បាប់ល្បើកថ្មី & ក្រមង៉ុយ (Kram Ngoy Wisdom)', 'Kram Ngoy Moral Verses', 'ស្វែងយល់ពីពាក្យទូន្មាន និងកាព្យអប់រំចិត្តរបស់បណ្ឌិតក្រមង៉ុយ។', 'beginner', 190, 60, 'Feather', 'Moral Verses', [
    { q: 'កវីល្បីល្បាញខាងកំណាព្យទូន្មានប្រៀនប្រដៅគឺ៖', options: ['អ្នកភិរម្យភាសាអ៊ូ ហៅ ក្រមង៉ុយ', 'ភិក្ខុសោម', 'ញ៉ុក ថែម', 'រីម គីន'], answer: 0, explanation: 'ក្រមង៉ុយ' },
    { q: 'ស្នាដៃរបស់ក្រមង៉ុយរួមមាន៖', options: ['ច្បាប់ល្បើកថ្មី, ច្បាប់កេរកាល, ពាក្យកាព្យទូន្មាន', 'ទុំទាវ', 'កុលាបប៉ៃលិន', 'សុភាត'], answer: 0, explanation: 'ច្បាប់ល្បើកថ្មី និងច្បាប់កេរកាល' }
  ]),
