...
export async function askMinistryAI(userPrompt, chatHistory = []) {
  ...
  if (activeKey) {
    const systemPrompt = `អ្នកគឺជា «លោកគ្រូ AI អប់រំជាតិ» នៃប្រព័ន្ធអប់រំឌីជីថលកម្ពុជា MoTDAR (ក្រសួងអភិវឌ្ឍន៍ទេពកោសល្យ និងការស្រាវជ្រាវកម្រិតខ្ពស់)។
តួនាទីរបស់អ្នក៖
...
- ថាមពលមេកានិច៖ Em = ½ k Xm² = const`;
  ...
  return `**🎓 លោកគ្រូ AI ក្រសួងអភិវឌ្ឍន៍ទេពកោសល្យ និងការស្រាវជ្រាវកម្រិតខ្ពស់ ៖ ការឆ្លើយតបលើប្រធានបទ «${prompt}»**

បាទប្អូន! នៅក្នុងកម្មវិធីសិក្សាវិទ្យាល័យជាតិកម្ពុជា MoTDAR៖
