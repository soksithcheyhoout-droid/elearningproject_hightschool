    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-6 font-kantumruy">
      ...
      <div className="lg:col-span-2 p-3.5 sm:p-6 bg-white/95 dark:bg-[#0f172a] backdrop-blur-md rounded-2xl sm:rounded-3xl border border-slate-200/90 dark:border-slate-800 flex flex-col justify-between shadow-md">
        <div className="space-y-2.5 sm:space-y-4">
          ...
          <div>
            <h3 className="text-sm sm:text-lg font-black text-[#002b5b] dark:text-white font-kantumruy leading-snug sm:leading-[1.6]">
              {'\u1782\u1793\u17d2\u179b\u17b9\u17c7\u178a\u17c4\u17c7\u179f\u17d2\u179a\u17b6\u1799\u179c\u17b7\u1789\u17d2\u1789\u17b6\u179f\u17b6\u1794\u17b6\u1780\u17cb\u178c\u17bb\u1794\u1782\u178e\u17b7\u178f\u179c\u17b7\u1791\u17d2\u1799\u17b6 \u1793\u17b7\u1784\u179a\u17bc\u1794\u179c\u17b7\u1791\u17d2\u1799\u17b6 \u1792\u17d2\u179b\u17b6\u1780\u17cb\u1789\u17b9\u1780\u1789\u17b6\u1794\u17cb\u1794\u17c6\u1795\u17bb\u178f'}
            </h3>
            <p className="text-[11px] sm:text-sm text-slate-700 dark:text-slate-300 mt-1 sm:mt-2 leading-relaxed font-medium line-clamp-3 sm:line-clamp-none">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-1.5 sm:gap-3 pt-1 text-xs text-slate-700 dark:text-slate-300 font-bold">
            <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900/90 p-2 sm:p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-2xs">
        ...
        <div className="pt-3 sm:pt-5 mt-3 sm:mt-4 border-t border-slate-100 dark:border-slate-800 flex items-center gap-2 sm:gap-3">
          <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-xl bg-blue-50 dark:bg-slate-900 border border-blue-200 dark:border-slate-800 p-1 flex items-center justify-center shadow-2xs shrink-0">
            <img src="/assets/moeys-crest-transparent.png" alt="MoTDAR" className="w-full h-full object-contain" />
          </div>
          <div className="min-w-0">
            <p className="text-[10px] sm:text-xs font-bold text-slate-900 dark:text-white truncate">{'\u1780\u17d2\u179a\u17bb\u1798\u1780\u17b6\u179a\u1784\u17b6\u179a\u179f\u17d2\u179a\u17b6\u179c\u1787\u17d2\u179a\u17b6\u179c\u1782\u179a\u17bb\u1780\u17c4\u179f\u179b\u17d2\u1799'}</p>
            <p className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400 font-medium truncate">{'\u1780\u17d2\u179a\u179f\u17bd\u1784\u17a2\u1797\u17b7\u179c\u178c\u17d2\u178d\u1793\u17cd\u1791\u17c1\u1796\u1780\u17c4\u179f\u179b\u17d2\u1799'} (MoTDAR)</p>
          </div>
        </div>
      ...
      <div className="p-3.5 sm:p-6 bg-white/95 dark:bg-[#0f172a] backdrop-blur-md rounded-2xl sm:rounded-3xl border border-slate-200/90 dark:border-slate-800 flex flex-col justify-between shadow-md">
        <div className="space-y-2 sm:space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] sm:text-xs text-amber-700 dark:text-amber-400 font-bold font-cinzel">
              +50 XP
            </span>
          </div>

          <p className="text-[10px] sm:text-xs font-bold text-sky-700 dark:text-cyan-400">
            {dailyQuestion.subject}
          </p>

          <p className="text-[11px] sm:text-sm text-slate-900 dark:text-white font-semibold leading-relaxed">
          ...
          <div className="space-y-1.5 sm:space-y-2 pt-0.5 sm:pt-1">
            {dailyQuestion.options.map((opt, idx) => {
              let optClass = "bg-slate-50 dark:bg-slate-900/90 border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200 hover:border-amber-400 dark:hover:border-amber-400 hover:bg-amber-50/40 dark:hover:bg-slate-800";
              if (dailyAnswered) {
                if (idx === dailyQuestion.correctIndex) {
                  optClass = "bg-emerald-50 dark:bg-emerald-950/60 border-emerald-400 dark:border-emerald-500 text-emerald-900 dark:text-emerald-200 font-bold";
                } else if (selectedOption === idx) {
                  optClass = "bg-rose-50 dark:bg-rose-950/60 border-rose-400 dark:border-rose-500 text-rose-900 dark:text-rose-200";
                }
              }
