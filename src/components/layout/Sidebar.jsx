...
export default function Sidebar({ activeTab, setActiveTab, onOpenAITutor }) {
  ...
  return (
    <aside className="w-72 hidden md:flex flex-col flex-shrink-0 bg-white/95 backdrop-blur-md border-r border-slate-200/90 py-4 px-3 space-y-3 select-none shadow-xs font-kantumruy overflow-y-auto sticky top-[102px] sm:top-[108px] h-[calc(100vh-102px)] sm:h-[calc(100vh-108px)] self-start z-10 pb-8 [scrollbar-width:thin] [scrollbar-color:rgba(0,91,170,0.15)_transparent]">
